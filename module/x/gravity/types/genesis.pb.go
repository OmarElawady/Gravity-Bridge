...
type GenesisState struct {
	...
	EthErc20ToDenoms   []ERC20ToDenom              `protobuf:"bytes,12,rep,name=eth_erc20_to_denoms,json=ethErc20ToDenoms,proto3" json:"eth_erc20_to_denoms"`
	UnbatchedTransfers []OutgoingTransferTx        `protobuf:"bytes,13,rep,name=unbatched_transfers,json=unbatchedTransfers,proto3" json:"unbatched_transfers"`
}
...
func (m *GenesisState) GetEthErc20ToDenoms() []ERC20ToDenom {
	if m != nil {
		return m.EthErc20ToDenoms
	}
	return nil
}
...
var fileDescriptor_387b0aba880adb60 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EthErc20ToDenoms) > 0 {
		for iNdEx := len(m.EthErc20ToDenoms) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.EthErc20ToDenoms[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.EthErc20ToDenoms) > 0 {
		for _, e := range m.EthErc20ToDenoms {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EthErc20ToDenoms", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EthErc20ToDenoms = append(m.EthErc20ToDenoms, ERC20ToDenom{})
			if err := m.EthErc20ToDenoms[len(m.EthErc20ToDenoms)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 13:
